...
import { getDexSessionCookie, validateDexSession, getCookieExpiration } from '../dex-auth';
...
describe('DEX Authentication Utility', () => {
    ...
    describe('getDexSessionCookie', () => {
            ...
            const mockResponses = [
                ...
                // Login POST - redirect to callback
                {
                    ...
                    headers: new Headers({
                        ...
                        'set-cookie': 'authservice_session=test_session_token; expires=Wed, 17 Dec 2025 19:00:00 GMT',
                    }),
                    url: 'https://test.example.com/dex/auth/local/login',
                },
        ...
        it('should handle missing session cookie', async () => {
            ...
            expect(result.success).toBe(false);
            expect(result.error).toContain('Failed to obtain authservice_session cookie');
        });
    ...
    describe('getCookieExpiration', () => {
        it('should extract expiration from cookie string', () => {
            const cookie = 'authservice_session=token; expires=Wed, 17 Dec 2025 19:00:00 GMT; path=/';
