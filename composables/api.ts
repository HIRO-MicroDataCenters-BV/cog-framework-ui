 ...
 */
interface ModelRecommendParams {
 ...
 */
interface ModelFileUploadParams {
  /** Model ID */
  id: number;
  /** Files to upload */
  files: File[];
 ...
 */
interface DatasetFileUploadParams {
  /** Dataset ID */
  id: number;
  /** Files to upload */
  files: File[];
 ...
 */
interface PipelineComponentParams {
  /** Pipeline ID */
  pipeline_id?: string;
  /** Pipeline name */
 ...
 */
interface InferenceServiceParams {
