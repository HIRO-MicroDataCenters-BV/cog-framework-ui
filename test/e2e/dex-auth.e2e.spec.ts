...
describe('DEX Authentication E2E Flow', () => {
    ...
    describe('Complete OAuth Flow', () => {
        it('should complete full authentication flow successfully', async () => {
            ...
            const responses = [
                ...
                // Step 5: POST login → redirect with session
                {
                    ...
                    headers: new Headers({
                        ...
                        'set-cookie': 'authservice_session=valid_session_token; expires=Wed, 17 Dec 2025 19:00:00 GMT; path=/; HttpOnly; Secure',
                    }),
                    url: 'https://dashboard.cog.hiro-develop.nl/dex/auth/local/login',
                },
            ...
            expect(result.cookie).toContain('authservice_session=valid_session_token');
    ...
    describe('Session Lifecycle', () => {
        it('should handle session creation, validation, and expiration', async () => {
            ...
            mockFetch.mockResolvedValueOnce({
                ...
                headers: {
                    get: () => '/callback',
                    getSetCookie: () => [`authservice_session=test_token; expires=${new Date(expiryTime).toUTCString()}`],
                },
            });
