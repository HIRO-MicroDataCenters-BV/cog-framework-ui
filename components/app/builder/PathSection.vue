<template>
  <div class="mb-6">
    <h3 class="mb-3 text-xs uppercase tracking-wider font-bold text-muted-foreground flex items-center gap-2">
    ...
    <div class="space-y-2">
      ...
      >
        ...
        <span 
          ...
          :style="{ borderColor: getTypeColor(path.type), color: getTypeColor(path.type) }"
        >
          {{ path.type }}
        </span>
      </div>
