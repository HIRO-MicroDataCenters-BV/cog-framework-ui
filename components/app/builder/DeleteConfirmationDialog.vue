    ...
    <AlertDialogContent class="max-w-md">
      <AlertDialogHeader>
        ...
        <AlertDialogDescription class="space-y-3">
          ...
          <div class="bg-destructive/10 border border-destructive/30 rounded-lg p-3 flex items-start gap-2">
            <Icon name="lucide:shield-alert" class="w-4 h-4 text-destructive mt-0.5 flex-shrink-0" />
