...
<template>
  ...
  >
    ...
    <div
      :class="
        cn(
          `duration-200 relative h-${props.height} w-[--sidebar-width] bg-transparent transition-[width] ease-linear`,
    ...
    <div
      :class="
        cn(
          `duration-200 fixed inset-y-0 z-10 hidden h-${props.height} w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex`,
          side === 'left'
